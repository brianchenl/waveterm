...
| term:showsplitbuttons <VersionBadge version="v0.15" />               | bool     | when enabled, shows split horizontal and vertical buttons in the terminal block header (defaults to false)                                                                                                                                                      |
...
```json
{
    ...
    "web:defaulturl": "https://codeup.aliyun.com/",

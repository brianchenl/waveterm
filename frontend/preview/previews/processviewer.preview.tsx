...
const MockProcesses: ProcessInfo[] = [
    ...
    { pid: 789, ppid: 1, command: "node", user: "mike", cpu: 8.7, mem: 256 * 1024 * 1024, mempct: 0.78, numthreads: 1 },
    {
        pid: 1001,
        ppid: 1,
        command: "Electron",
    ...
    { pid: 2001, ppid: 1, command: "sshd", user: "root", cpu: 0.0, mem: 8 * 1024 * 1024, mempct: 0.02, numthreads: 1 },
    {
        pid: 2345,
        ppid: 1,
        command: "postgres",
    ...
    { pid: 3001, ppid: 1, command: "nginx", user: "_www", cpu: 0.3, mem: 32 * 1024 * 1024, mempct: 0.1, numthreads: 1 },
    {
        pid: 3456,
        ppid: 1,
        command: "python3",
    ...
    { pid: 5001, ppid: 1, command: "zsh", user: "mike", cpu: 0.0, mem: 6 * 1024 * 1024, mempct: 0.02, numthreads: 1 },
    {
        pid: 5678,
        ppid: 5001,
        command: "vim",

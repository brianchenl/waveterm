...
import { RowHeight, type ProcessViewerViewModel, type SortCol } from "./processviewer";
...
const Columns: ColDef[] = [
    { key: "pid", labelKey: "PID", width: "70px", align: "right" },
    { key: "command", labelKey: "Command", width: "minmax(120px, 4fr)" },
    { key: "status", labelKey: "Status", width: "75px", hideOnPlatform: ["windows", "darwin"] },
    { key: "user", labelKey: "User", width: "80px", hideOnPlatform: ["windows"] },
    {
        key: "threads",
        labelKey: "NT",
        tooltipKey: "Num Threads",
        width: "40px",
        align: "right",
        hideOnPlatform: ["windows"],
    },
    { key: "cpu", labelKey: "CPU%", width: "70px", align: "right" },
    { key: "mem", labelKey: "Memory", width: "90px", align: "right" },
];
...
const StatusIndicator = React.memo(function StatusIndicator({ model }: { model: ProcessViewerViewModel }) {
    ...
    const statusLabel = t(error != null ? "Error" : stalled ? "Stalled" : "Updating");
    const tooltipContent = (
        <div className="flex flex-col gap-0.5">
    ...
    return (
        ...
        >
            {cols.map((col) => (
                <Tooltip
                    key={col.key}
                    content={col.tooltipKey ? t(col.tooltipKey) : undefined}
                    disable={!col.tooltipKey}

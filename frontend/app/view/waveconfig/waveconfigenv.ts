...
export type WaveConfigEnv = WaveEnvSubset<{
    ...
    rpc: {
        ...
        WindowsDiagnosticsCommand: WaveEnv["rpc"]["WindowsDiagnosticsCommand"];
        AIProviderTestCommand: WaveEnv["rpc"]["AIProviderTestCommand"];
    };
    atoms: {
        fullConfigAtom: WaveEnv["atoms"]["fullConfigAtom"];
    };
    getBlockMetaKeyAtom: MetaKeyAtomFnType<"file">;
    getSettingsKeyAtom: SettingsKeyAtomFnType<"app:language">;
